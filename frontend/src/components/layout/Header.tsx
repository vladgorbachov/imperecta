...
export function Header({ onMenuClick, notificationCount = 0 }: HeaderProps) {
  ...
  return (
    <header
      className="flex h-12 min-h-[44px] min-w-0 shrink-0 items-center justify-between overflow-hidden px-3 backdrop-blur-xl safe-area-top sm:h-14 sm:px-4 md:px-5"
    >
