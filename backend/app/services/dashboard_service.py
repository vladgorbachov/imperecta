...
LEGACY: Used by dashboard API, analytics API, and ai_chat_service (get_anomalies).
New Markets data flows use app.services.market_data and app.services.markets_service instead.
Do not route Markets functionality through this service.
"""
