...
from app.services.market_data.dto import NormalizedForex
from app.services.market_data.providers.base import ForexProviderAdapter
    ...
    async def fetch(self) -> list[NormalizedForex]:
        ...
        for quote, rate in rates.items():
            try:
                ...
                logger.warning("Parse forex %s/%s: %s", base, quote, e)
                continue
