...
def test_contract_structure_loaded() -> None:
    # Contract tables grew with the module map (alerts, chat, users, weekly
    # price rollup, ...): update deliberately when a new gated table lands.
    assert len(FACT_TABLE_CONTRACTS) == 25
